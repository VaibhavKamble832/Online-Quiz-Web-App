...
<nav>
	...
	<div class="card">
		...
		<h1>Update Subject Here</h1>		
		
		<form action="SubjectServlet" method="post">
			
			<input type="hidden" name="action" value="editSubject">
			
			<input type="text" name="id" value="<%=subject.getId() %>" required="required">
			<input type="text" name="subject_name" value="<%=subject.getSubject_name() %>" required="required">
